...
void protobuf_AssignDesc_ssl_5fwrapper_2eproto() {
  protobuf_AddDesc_ssl_5fwrapper_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_ssl_5fwrapper_2eproto);
}
...
void protobuf_ShutdownFile_ssl_5fwrapper_2eproto() {
  delete SSL_WrapperPacket::default_instance_;
  delete SSL_WrapperPacket_reflection_;
}

void protobuf_AddDesc_ssl_5fwrapper_2eproto() {
  static bool already_here = false;
  if (already_here) return;
  already_here = true;
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  ::protobuf_AddDesc_ssl_5fdetection_2eproto();
  ::protobuf_AddDesc_ssl_5fgeometry_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "e\022#\n\010geometry\030\002 \001(\0132\021.SSL_GeometryData", 158);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "ssl_wrapper.proto", &protobuf_RegisterTypes);
  SSL_WrapperPacket::default_instance_ = new SSL_WrapperPacket();
  SSL_WrapperPacket::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_ssl_5fwrapper_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_ssl_5fwrapper_2eproto {
  StaticDescriptorInitializer_ssl_5fwrapper_2eproto() {
    protobuf_AddDesc_ssl_5fwrapper_2eproto();
  }
} static_descriptor_initializer_ssl_5fwrapper_2eproto_;
...
const SSL_WrapperPacket& SSL_WrapperPacket::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_ssl_5fwrapper_2eproto();  return *default_instance_;
}
