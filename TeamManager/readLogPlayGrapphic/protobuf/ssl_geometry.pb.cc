...
void protobuf_AssignDesc_ssl_5fgeometry_2eproto() {
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_ssl_5fgeometry_2eproto);
}
...
void protobuf_ShutdownFile_ssl_5fgeometry_2eproto() {
...
void protobuf_AddDesc_ssl_5fgeometry_2eproto() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "ssl_geometry.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_ssl_5fgeometry_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_ssl_5fgeometry_2eproto {
  StaticDescriptorInitializer_ssl_5fgeometry_2eproto() {
    protobuf_AddDesc_ssl_5fgeometry_2eproto();
  }
} static_descriptor_initializer_ssl_5fgeometry_2eproto_;
...
const SSL_GeometryFieldSize& SSL_GeometryFieldSize::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_ssl_5fgeometry_2eproto();  return *default_instance_;
}
